    ...
    $.fn.jqtree = function (options) {
        ...
        function initClickNode() {
            ...
            $('.tree li.parent_li > span').on('click', function (e) {
                ...
                if (children.is(":visible")) {
                    children.hide('fast');
                    $(this).attr('title', '展开').find(' > i').addClass('icon-plus-sign fa fa-pencil-square-o').removeClass('icon-minus-sign fa fa-plus-square-o');
                } else {
                    children.show('fast');
                    $(this).attr('title', '收起').find(' > i').addClass('icon-minus-sign fa fa-plus-square-o').removeClass('icon-plus-sign fa fa-pencil-square-o');
                }
        ...
        function initTree(data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                strHtml += "<li id=\"li_" + data[i].id + "\"><span id=\"span_" + data[i].id + "\"><i class=\"fa fa-pencil-square-o " + strIconStyle + "\"></i>" + data[i].text + "</span>" + strHtmlUL + "</li>";
