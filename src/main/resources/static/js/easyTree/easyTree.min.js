        ...
        b = a.extend(c, b), this.each(function () {
            ...
            a.each(a(c).find("ul > li"), function () {
                ...
                if (a(this).is("li:has(ul)")) {
                    ...
                    console.log(c), a(c).remove(), b = a(this).text(), a(this).html('<span><span class="glyphicon"></span><a href="javascript: void(0);"></a> </span>'), a(this).find(" > span > span").addClass("glyphicon-folder-open"), a(this).find(" > span > a").text(b), a(this).append(c)
                } else b = a(this).text(), a(this).html('<span><span class="glyphicon"></span><a href="javascript: void(0);"></a> </span>'), a(this).find(" > span > span").addClass("glyphicon-file"), a(this).find(" > span > a").text(b)
                ...
                a(e).append(f), a(f).find("input").focus(), a(f).find(".confirm").text(b.i18n.confirmButtonLabel), a(f).find(".confirm").click(function () {
                    if ("" !== a(f).find("input").val()) {
                        var e = g(),
                            h = a('<li><span><span class="glyphicon glyphicon-file"></span><a href="javascript: void(0);">' + a(f).find("input").val() + "</a> </span></li>");
                        a(h).find(" > span > span").attr("title", b.i18n.collapseTip), a(h).find(" > span > a").attr("title", b.i18n.selectTip), e.length <= 0 ? a(c).find(" > ul").append(a(h)) : e.length > 1 ? (a(c).prepend(d), a(c).find(".alert .alert-content").text(b.i18n.addMultiple)) : a(e).hasClass("parent_li") ? a(e).find(" > ul").append(h) : (a(e).addClass("parent_li").find(" > span > span").addClass("glyphicon-folder-open").removeClass("glyphicon-file"), a(e).append(a("<ul></ul>")).find(" > ul").append(h)), a(f).find("input").val(""), b.selectable && (a(h).find(" > span > a").attr("title", b.i18n.selectTip), a(h).find(" > span > a").click(function (d) {
            ...
            })), b.editable && (a(c).find(".easy-tree-toolbar").append('<div class="edit"><button class="btn btn-default btn-sm btn-primary disabled"><span class="glyphicon glyphicon-edit"></span></button></div> '), a(c).find(".easy-tree-toolbar .edit > button").attr("title", b.i18n.editTip).click(function () {
            ...
            })), b.deletable && (a(c).find(".easy-tree-toolbar").append('<div class="remove"><button class="btn btn-default btn-sm btn-danger disabled"><span class="glyphicon glyphicon-remove"></span></button></div> '), a(c).find(".easy-tree-toolbar .remove > button").attr("title", b.i18n.deleteTip).click(function () {
                var f = g();
                ...
                d.is(":visible") ? (d.hide("fast"), a(this).attr("title", b.i18n.expandTip).find(" > span.glyphicon").addClass("glyphicon-folder-close").removeClass("glyphicon-folder-open")) : (d.show("fast"), a(this).attr("title", b.i18n.collapseTip).find(" > span.glyphicon").addClass("glyphicon-folder-open").removeClass("glyphicon-folder-close")), c.stopPropagation()
